...
$sql = "INSERT INTO tb_professor_estud(estud, prof)VALUES('$estud', '$prof')";
$execute = mysqli_query($conexao, $sql);
if($execute == true){
    $_SESSION['profAdd'] = "Professor(a) do(a) estudante adicionado com sucesso!";
    
}else{
    $_SESSION['profAddErro'] = "Falha tente novamente";
}
