...
$estudante = $_GET['id_estud'];
$dia_freq = $_POST['dia_freq'];
$data_freq = $_POST['data_freq'];
$status_freq = $_POST['status_freq'];

$sql = "INSERT INTO tb_frequencias(estudante, dia_freq, data_freq, status_freq)
VALUES('$estudante', '$dia_freq', '$data_freq', '$status_freq')";
$execute = mysqli_query($conexao, $sql);
if($execute == true){
    $_SESSION['chamadaAdd'] = "Chamada realizada com sucesso!";
    
}else{
    $_SESSION['chamadaAddErro'] = "Falha tente novamente";
}
                        ...
                        <div class="modal-header">
                             <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                 ...
                                 <small id="pergunta-modal">
                                     <?= $_SESSION['chamadaAdd'];?></small><br><br>
